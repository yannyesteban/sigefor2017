...
if ((substr_count (strtoupper($query), strtoupper("UPDATE "))==0 AND
	...
	for ($i=0; $i<$number_cols; $i++){
		$campos .= (($campos!="")?",":"").(($con_tablas=="1")?mysql_field_table($result, $i).".":"").mysql_field_name($result, $i) ;
	}// next
	$tabla = ($tabla=="" or $tabla==null)?$_GET["tabla"]:$tabla;
	...
	echo ("<br><textarea  cols=\"100\" rows=\"10\">".htmlentities($q)."</textarea><hr>");
...
<input name="con_tablas" type="checkbox" id="con_tablas" value="1" />
