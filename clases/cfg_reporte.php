...
define("C_REP_ERR_NO_PAGINAS","La(s) pagina(s) solicitada(s) está(n) fuera de rango");
...
class cfg_reporte{
	...
	var $vexp = array();
	//===========================================================
	public $q_maestro = false;
	public $totalizar_exp = false;
	public $no_totalizar = true;
	public $ele_corte = false;
