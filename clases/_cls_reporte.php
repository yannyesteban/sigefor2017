...
class cls_reporte extends cfg_reporte{
	...
	function rep_rapido(){
		...
		$this->cuerpo_pie_informe = extraer_patron($this->diagrama,"cuerpo_pie_informe");
		$this->diagrama = inner_html($this->diagrama,"cuerpo_pie_informe","");		
		...
		while ($rs = $rs_x){
			...
			$detalle_x = $this->evaluar_exp($detalle_x);
			//===========================================================
		...
		$detalle_blanco = $this->evaluar_exp($detalle_blanco);
		...
		return $this->pag_informe.$this->cuerpo_pie_informe;	
	}// end fucntion
	//===========================================================
