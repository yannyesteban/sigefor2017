...
class cls_element_html{
	...
	var $property = "";
    //======================================
	function __construct($tipo_x="",$nombre_x=""){
		$this->type = $tipo_x;
		$this->name = $nombre_x;
    }// end function
    //======================================
    function doit(){
        ...
        $cad .= ($this->placeholder != "")?" placeholder=\"$this->placeholder\"":"";
    ...
    function control(){
		switch (strtolower($this->type)){
			...
			case "color":
				...
				break;
			case "textarea":
                $cad = "<textarea".$this->doit().">".$this->value."</textarea>";
                break;
            case "a":
			case "select":
            case "option":
            case "optgroup":
                $cad = "<$this->type".$this->doit().">".$this->inner_html."</$this->type>";
                break;
            case "img":
            case "hr":
                $cad = "<$this->type".$this->doit().">";
                break;
			default:
                $cad = "<$this->type".$this->doit().">".$this->inner_html."</$this->type>";
				break;
