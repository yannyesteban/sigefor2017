...
class cls_documento{
	...
	var $http_equiv = "";// "\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".(SS_CHARSET)." \"><meta name='viewport' content='width=device-width, initial-scale=1'/>";
    var $keywords = "";
    var $description = "";
	var $refresh = "";
    var $style_value = "";
    ...
    function control($tipo_x=C_MODO_DOC){
		if ($tipo_x==C_MODO_DOC){	
			...
			if($this->http_equiv){
				...
				$doc .= "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".(SS_CHARSET)."\"><meta name='viewport' content='width=device-width, initial-scale=1'/>";
			}
