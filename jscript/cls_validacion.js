...
�ltima revision: 01 de Agosto de 2007, 03:35pm.
�ltima revision: 25 de Mayo de 2011, 06:22pm.
Nombre del Archivo: cls_validaciones.js
Lenguaje: JavaScript 1.2
							.*.*.*.*.*.*.*.
Programado por: Yanny N��ez
...
function para_validacion(nombre_x){
	...
	this.msg_alfabetico = "El campo "+this.patron+" solo debe tener caracteres alfab�ticos"
	...
	this.msg_numerico = "El campo "+this.patron+" debe ser un valor num�rico"
	this.msg_entero = "El campo "+this.patron+" debe ser un n�mero entero"
	this.msg_positivo = "El campo "+this.patron+" debe ser un n�mero positivo"
	this.msg_email = "El campo "+this.patron+" no es una direcci�n de correo v�lida"
	this.msg_fecha = "El campo "+this.patron+" no es una fecha v�lida"
	this.msg_hora = "El campo "+this.patron+" no es una hora v�lida"
	this.msg_exp = "El campo "+this.patron+" no coincide con un patr�n v�lido"
	...
	this.msg_maxsize = "El Tamaño del Archivo en el campo "+this.patron+" es superior al permitido"
	this.msg_extensiones = "La Extensión del Archivo en el campo "+this.patron+" no está permitida"
	// ***** METODOS *****
...
function cls_validacion(){
	...
	function validar(valid,nombre_x,valor_x,titulo_x){
		...
		if (this.prop.alfabetico == "si" && !this.eval_exp("^([ A-Z��������������]+)$",valor)){
